...
if (__name__ == "__main__"):
    item_list = {
        "bla": [
            meuporg_item("    // * !TODO! :! * blabla! And bla too!","./here.txt",1),
            meuporg_item("blabla bla !FIXREF! blabla! blabla","./here/wait/no/actually/there.bla",123456)
        ],
        "blo": {
            "blu" :
            [
                meuporg_item("    // * !IDEA! :! * blabla! And bla too!","./here.txt",1),
                meuporg_item("blabla bla !IDEA! blabla! blabla","./here/wait/no/actually/there.bla",123456)
            ],
            "bly" :
            [
                meuporg_item("    // * !TODO! :! * blabla! And bla too!","./here.txt",1),
