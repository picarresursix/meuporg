...
class meuporg_item:
    ...
    """An item is a string matching the following regex. Recall that
    an item is made of uppercased letters, underscores and numbers
    (and nothing else) enclosed between exclamation marks.
...
if (__name__ == "__main__"):
    ...
    print basic_format.format(meuporg_item(
